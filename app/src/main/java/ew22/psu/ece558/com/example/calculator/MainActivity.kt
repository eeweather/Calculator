...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // really thought about how I could loop through this but had trouble passing my button
        // objects and decided I liked practicing abstract classes more.
    ...
    fun ToastTwoOps(context: Context) {
        Toast.makeText(context, context.getString(R.string.two_ops), Toast.LENGTH_LONG).show()
        return
    }

    fun ToastOneOps(context: Context) {
        Toast.makeText(context, context.getString(R.string.one_ops), Toast.LENGTH_LONG).show()
        return
    }
}
